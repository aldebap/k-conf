...
// Test_UpdateUpstream unit tests for UpdateUpstream() method
func Test_UpdateUpstream(t *testing.T) {

	t.Run(">>> UpdateUpstream: scenario 1 - upstream not found", func(t *testing.T) {
		...
		want := errors.New("upstream not found")
		got := kongServer.UpdateUpstream("1234", &KongUpstream{}, Options{
			verbose:    false,
			jsonOutput: false,
		})
	...
	t.Run(">>> UpdateUpstream: scenario 2 - internal server error", func(t *testing.T) {
		...
		want := errors.New("fail sending patch upstream command to Kong: 500 Internal Server Error")
		got := kongServer.UpdateUpstream("1234", &KongUpstream{}, Options{
			verbose:    false,
			jsonOutput: false,
		})
	...
	t.Run(">>> UpdateUpstream: scenario 3 - upstream returned successfuly", func(t *testing.T) {
...
// Test_DeleteUpstream unit tests for DeleteUpstream() method
func Test_DeleteUpstream(t *testing.T) {

	t.Run(">>> DeleteUpstream: scenario 1 - upstream not found", func(t *testing.T) {
		...
		want := errors.New("fail sending delete upstream command to Kong: 404 Not Found")
		got := kongServer.DeleteUpstream("1234", Options{
			verbose:    false,
			jsonOutput: false,
		})
	...
	t.Run(">>> DeleteUpstream: scenario 2 - upstream returned successfuly", func(t *testing.T) {
