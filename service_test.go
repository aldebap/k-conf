...
// Test_UpdateService unit tests for UpdateService() method
func Test_UpdateService(t *testing.T) {

	t.Run(">>> UpdateService: scenario 1 - service not found", func(t *testing.T) {
		...
		want := errors.New("service not found")
		got := kongServer.UpdateService("1234", &KongService{}, Options{
			verbose:    false,
			jsonOutput: false,
		})
	...
	t.Run(">>> DeleteService: scenario 2 - internal server error", func(t *testing.T) {
		...
		want := errors.New("fail sending patch service command to Kong: 500 Internal Server Error")
		got := kongServer.UpdateService("1234", &KongService{}, Options{
			verbose:    false,
			jsonOutput: false,
		})
	...
	t.Run(">>> DeleteService: scenario 3 - service returned successfuly", func(t *testing.T) {
